// User profile, entered by each person about themselves, saved only in this
// browser's local storage. Nothing is sent to a server. There is no login,
// so this profile belongs to whoever is using this device.

...
// mood. Each song links to one specific, verified YouTube video (real
// video ID, cross-checked against its title/channel), not a search, so a
// real thumbnail can be shown. Also keeps a search link as a backup, in
// case someone prefers a different singer's version.
    ...
    songs: [
      {
        ...
        videoId: "H_9JanyPGso",
        videoSource: "Lata Mangeshkar, Official Video",
      ...
      },
      {
        ...
        videoId: "chHkGBIdnoU",
        videoSource: "Vikram Hazra, Art of Living Bhajan",
    ...
    songs: [
      {
        ...
        videoId: "1qmPNot9NJs",
        videoSource: "Jubin Nautiyal, T-Series",
      ...
      },
      {
        ...
        videoId: "Sqme-7OSCi8",
        videoSource: "Zee Music Devotional",
    ...
    songs: [
      {
        ...
        videoId: "gJS15a0oEUQ",
        videoSource: "M.S. Subbulakshmi, Evergreen Melodies",
    ...
    songs: [
      {
        ...
        videoId: "f7mGOuibXj8",
        videoSource: "ISKCON Temple Songs",
